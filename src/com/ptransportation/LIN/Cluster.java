...
import com.ptransportation.LIN.encoding.Encoding;
import com.ptransportation.LIN.frame.EventTriggeredFrame;
import com.ptransportation.LIN.frame.Frame;
import com.ptransportation.LIN.frame.UnconditionalFrame;
...
public class Cluster {
    ...
    public Set<UnconditionalFrame> getUnconditionalFrames() {
        HashSet<UnconditionalFrame> unconditionalFrames = new HashSet<UnconditionalFrame>();
        for(Slave slave:slaves)
    ...
    public Set<EventTriggeredFrame> getEventTriggeredFrames() {
        HashSet<EventTriggeredFrame> eventTriggeredFrames = new HashSet<EventTriggeredFrame>();
        for(Slave slave:slaves)
